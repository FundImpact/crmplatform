 ...
 *
 * @description: user stores user details .
 */
    ...
    async callback(ctx) {
      ...
      async register(ctx) {
        ...
        try {
          ...
          let contactParams = {name : params.organization.name , contact_type : 'organization'}
          const contact  = await strapi.query('contact', "crm-plugin").create(contactParams);
          ...
          params.organization.contact = contact.id;
